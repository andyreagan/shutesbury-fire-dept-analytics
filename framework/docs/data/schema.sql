...
CREATE TABLE Inc_unit_extended(Unit VARCHAR, Inci_no VARCHAR, Alm_date DATE, Fdid BIGINT, Unit_id VARCHAR, Resp_code VARCHAR, Arv_date DATE, Arv_same BOOLEAN, Arv_time TIME, Arv_dttm VARCHAR, Unit_combined VARCHAR);
